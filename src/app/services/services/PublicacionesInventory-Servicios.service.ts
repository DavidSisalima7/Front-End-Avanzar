...
export class PublicacionesInventoryServicios
{
    ...
    listarServicio(): void {
        this._httpClient.get<InventarioPublicaciones[]>("http://evamarket.ec:8080/api/publicaciones/listarServicio")
          .subscribe((data) => {
      ...
      obtenerListaPublicacionesXServicio(): Observable<InventarioPublicaciones[]> {
        return this._httpClient.get<InventarioPublicaciones[]>("http://evamarket.ec:8080/api/publicaciones/listarServicio")
          .pipe(
