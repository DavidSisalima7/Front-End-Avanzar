...
import { FavoritosClientComponent } from '../favoritos.component';
...
@Component({
    ...
    templateUrl: './modal-destacados.component.html',
    styleUrls: ['./modal-destacados.component.scss'],
    standalone: true,
...
export class ModalDestacadosComponent implements OnInit {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalDestacadosComponent>,
    ...
    ngOnInit(): void {
            ...
            this._destacadoService.getPublicacionById(FavoritosClientComponent.publicacionSeleccionada)
            .subscribe((product) => {
