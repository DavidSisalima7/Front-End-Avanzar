...
export class InventoryService {
    ...
    /*
    listarServicio(): void {
        this._httpClient.get<InventarioPublicaciones[]>("http://evamarket.ec:8080/api/publicaciones/listaPublicacionesXProductos")
          .subscribe((data) => {
    ...
    listarServicio(): void {
        ...
        this._userService.user$
            ...
            .subscribe((vendedora: Vendedor) => {
                ...
                const url = `http://evamarket.ec:8080/api/publicaciones/listaPublicacionesXProductos/${vendedorId}`;
    ...
    getCategoriesProducto(): Observable<CategoriaProducto[]> {
        return this._httpClient.get<CategoriaProducto[]>('http://evamarket.ec:8080/api/categoriaProducto/listar').pipe(
            tap((categories) => {
    ...
    getProducts(
        ...
        return this._httpClient
            .get<{ pagination: InventoryPagination; products: InventarioPublicaciones[] }>('http://evamarket.ec:8080/api/publicaciones/listar', {
                params: params
            })
            .pipe(
